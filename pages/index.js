          ...
          <div>
              <div className="md:flex items-center mb-4">
                  <div className="flex items-center md:mr-8 mb-4 md:mb-0">
                      <i className="fas fa-envelope-open-text fa-2x mr-2"></i>
              ...
              <div className="md:flex items-center">
                  <div className="flex items-center md:mr-7">
                      <i className="fas fa-phone-alt fa-2x mr-2 mb-4 md:mb-0"></i>
          ...
          <div className="md:mr-20 md:w-1/3">
              ...
              <div className="relative mt-5 text-left">
                  ...
                  <div className="flex items-center relative pb-5 pt-5 justify-start">
                      ...
                      <div className="ml-6 pt-5">
                          <div className="flex mb-4 space-x-16">
                              ...
                              <div>
                                  <img className="w-24" src="https://i2.wp.com/mac-torrent-download.net/wp-content/uploads/2019/11/Navicat-Premium-15-icon.png?resize=246%2C246&ssl=1"/>
                              </div>
                              <div>
                          ...
                          <div className="flex mb-4 space-x-16">
                              ...
                              <div>
                                  <img className="w-24"  src="https://cdn.clipart.email/f7b6e038eb20af29a2864eebc3dd7a2b_android-studio-logo-png-picture-378911-android-studio-logo-png_512-512.png"/>
                              </div>
                              <div>
                  ...
                  <div className="flex items-center relative pb-5 pt-5 justify-start">
                      ...
                      <div className="ml-6 pt-5">
                          ...
                          <div className="flex mb-4 space-x-16">
                              ...
                              <div>
                                  <img className="w-24" src="https://www.markusantonwolf.com/media/pages/blog/alpine-js/1468511062-1596675049/alpinejs-logo.svg"/>
                              </div>
                              <div>
                  ...
                  <div className="flex items-center relative pb-5 pt-5 justify-start">
                      ...
                      <div className="border-r-2 border-black absolute h-full top-2 z-10">
                          <i className="fas fa-circle -top-1 -ml-2 absolute"></i>
                          <div className="absolute seccion -ml-8 font-bold italic text-gray-400">DESAROLLO&nbsp;MÓVIL</div>
